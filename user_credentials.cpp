            ...
            if (isNumber)
            {
                ...
                case 1:
                {
                    ...
                    send(client_socket, password.c_str(), password.size(), 0);
                     ...
                     thread send([&local_handle,username](){ local_handle.handle_send(username); });
                     sleep(1);
                    thread rec([&local_handle,username](){ local_handle.handle_rec(username); });
                    ...
                    // thread t2(handle_rec, username);
                    // thread t1(handle_send, username);
                ...
                case 2:
                {
                    ...
                    thread send([&local_handle,new_username](){ local_handle.handle_send(new_username); });
                    sleep(1);
                    thread rec([&local_handle,new_username](){ local_handle.handle_rec(new_username); });
                    ...
                    // thread t2(handle_rec, new_username);
                    // thread t1(handle_send, new_username);
